...
public class UserCheck {
	...
	public static void cumpleObligatorios(User user) throws BusinessException {
		BusinessCheck.isFalse(isVacio(user.getEmail()), "El login es obligatorio");
		BusinessCheck.isFalse(isVacio(user.getPassword()), "El password es obligatorio");
		BusinessCheck.isFalse(isVacio(user.getEmail()), "El email es obligatorio");		
	}
	
	private static boolean isVacio(String parameter) {
